...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "225437aa-19b6-4070-978a-31ea4b2d07e3", e._sentryDebugIdIdentifier = "sentry-dbid-225437aa-19b6-4070-978a-31ea4b2d07e3");
  } catch (e2) {
  }
}();
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-5par4z_START -->${$$result.title = `<title>${escape($t("community.ask.question"))}</title>`, ""}<!-- HEAD_svelte-5par4z_END -->`, ""} ${validate_component(DeleteModal, "DeleteModal").$$render(
      $$result,
      {
        onCancel: () => {
...
//# sourceMappingURL=_page.svelte-64e65307.js.map
