...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "d1b959d0-0dfc-4257-9ec3-3443cf354a36", e._sentryDebugIdIdentifier = "sentry-dbid-d1b959d0-0dfc-4257-9ec3-3443cf354a36");
  } catch (e2) {
  }
}();
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-igiws2_START -->${$$result.title = `<title>Ask the Community - KinetsHub</title>`, ""}<!-- HEAD_svelte-igiws2_END -->`, ""} <section class="w-full max-w-3xl mx-auto"><div class="p-5"><a class="text-gray-500 dark:text-white text-md flex items-center"${add_attribute("href", `/lms/community`, 0)}>${validate_component(ArrowLeft, "ArrowLeftIcon").$$render(
      $$result,
      {
        size: 24,
      ...
      {},
      {}
    )} ${escape($t("community.ask.go_back"))}</a> <div class="flex items-center justify-between"><h1 class="dark:text-white text-3xl font-bold">${escape($t("community.ask.ask_the"))}</h1> ${validate_component(PrimaryButton, "PrimaryButton").$$render(
      $$result,
      {
      ...
      {}
    )}</div> ${validate_component(TextEditor, "TextEditor").$$render(
      $$result,
      {
...
//# sourceMappingURL=_page.svelte-f7faeef2.js.map
