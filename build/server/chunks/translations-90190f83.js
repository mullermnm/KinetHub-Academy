import { w as writable, d as derived } from './index2-aea858a5.js';
...
!function() {
  try {
    ...
    n2 && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n2] = "12ae2871-9b53-47af-9410-cfc2f5fa2f11", e._sentryDebugIdIdentifier = "sentry-dbid-12ae2871-9b53-47af-9410-cfc2f5fa2f11");
  } catch (e2) {
  }
}();
  ...
  loaders: [
    {
      locale: "en",
      key: "",
      loader: async () => (await import('./en-c20ae70c.js')).default
    },
    {
      locale: "hi",
      key: "",
      loader: async () => (await import('./hi-acf3f460.js')).default
    },
    {
      locale: "fr",
      key: "",
      loader: async () => (await import('./fr-7d622cf1.js')).default
    },
    {
      locale: "pt",
      key: "",
      loader: async () => (await import('./pt-e02e127c.js')).default
    },
    {
      locale: "de",
      key: "",
      loader: async () => (await import('./de-a85f678c.js')).default
    },
    {
      locale: "vi",
      key: "",
      loader: async () => (await import('./vi-b6bbcf06.js')).default
    },
    {
      locale: "ru",
      key: "",
      loader: async () => (await import('./ru-ed75494f.js')).default
    },
    {
      locale: "es",
      key: "",
      loader: async () => (await import('./es-c4e92aed.js')).default
    }
  ]
};
const { t: t2, loading, locales, locale, initialized, translations, loadTranslations } = new D(config);
...
function lessonFallbackNote(note, translation, locale2) {
  if (!translation) {
    return note;
  }
  const content = translation[locale2];
  if (locale2 === LOCALE.EN && !content && note?.length) {
    return note;
  }
  return content;
}

export { handleLocaleChange as h, initialized as i, lessonFallbackNote as l, selectedLocale as s, t2 as t };
//# sourceMappingURL=translations-90190f83.js.map
